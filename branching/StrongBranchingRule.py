# Source: PySCIPOpt Documentation
# Link: https://pyscipopt.readthedocs.io/en/latest/tutorials/branchrule.html

# Note: This example is not equivalent to the strong branching rule in SCIP. It
# ignores some of the more complicated interactions in a MIP solver for information
# found during strong branching. These include but are not strictly limited to:
#   - What happens if a new primal solution is found and the bound is larger than
#       the cutoff bound?
#   - What happens if the bound for one of the children is above a cutoff bound?
#   - If probing is enabled then one would need to handle new-found bounds
#       appropriately.
